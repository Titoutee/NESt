...
impl PPU {
    ...
    pub fn read_data(&mut self) -> u8 {
        ...
        self.increment_vram_addr(); // Reads to 0x2007 (data register) increment the address register
    ...
    pub fn write_to_data(&mut self, value: u8) {
        ...
        self.increment_vram_addr(); // Writes to 0x2007 (data register) increment the address register
    }
...
pub mod test {
    ...
    fn test_read_status_resets_vblank() {
        ...
        assert_eq!(ppu.status.state() >> 7, 0);
    }
